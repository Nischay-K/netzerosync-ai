...
export default function Onboarding({ user, onComplete }: OnboardingProps) {
  ...
  return (
    <div className="onboarding-style-1">
      <div className="glass-panel glow-indigo fade-in onboarding-style-2">
        {/* Onboarding Header */}
        <div className="onboarding-style-3">
          <div>
            <h2 className="onboarding-style-4">Calculate Your Baseline</h2>
            <p className="onboarding-style-5">Help EcoTwin understand your carbon habits.</p>
          </div>
          <div className="onboarding-style-6">
            Step {step} of {totalSteps + 1}
          </div>
        </div>

        {/* Top Progress Track */}
        <div className="onboarding-style-7">
          {[1, 2, 3, 4, 5].map((s) => (
            <div
              key={s}
              className="onboarding-style-8" style={{ background: s <= step ? 'var(--secondary)' : 'var(--bg-tertiary)' }}
            />
          ))}
        </div>
        ...
        {/* Step 1: Transport */}
        {step === 1 && (
          <div className="fade-in onboarding-style-9">
            <div className="onboarding-style-10">
              <div className="onboarding-style-11">
                <Car size={24} />
              </div>
              <h3 className="onboarding-style-12">Transportation Habits</h3>
            </div>

            <div>
              <label className="onboarding-style-13">How do you commute most often?</label>
              <div className="onboarding-style-14">
                {[
                  ...
                  >
                    <div className="onboarding-style-16">{opt.label}</div>
                    <div className="onboarding-style-17">{opt.desc}</div>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div>
              <label htmlFor="distance-slider" className="onboarding-style-18">
                Weekly distance traveled: <strong className="onboarding-style-19">{answers.distancePerWeek} km</strong>
              </label>
              <input
                id="distance-slider"
                type="range"
            ...
            <div>
              <label htmlFor="flights-slider" className="onboarding-style-20">
                Number of flights per year (short & long haul): <strong className="onboarding-style-21">{answers.flightsPerYear}</strong>
              </label>
              <input
                id="flights-slider"
                type="range"
        ...
        {/* Step 2: Food */}
        {step === 2 && (
          <div className="fade-in onboarding-style-22">
            <div className="onboarding-style-23">
              <div className="onboarding-style-24">
                <Utensils size={24} />
              </div>
              <h3 className="onboarding-style-25">Diet & Consumption</h3>
            </div>

            <div>
              <label className="onboarding-style-26">What best describes your diet?</label>
              <div className="onboarding-style-27">
                {[
                  ...
                  <div
                    ...
                    className="glass-card onboarding-style-28"
                  ...
                  >
                    <div className="onboarding-style-29">{opt.label}</div>
                    <div className="onboarding-style-30">{opt.desc}</div>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div>
              <label htmlFor="local-food-slider" className="onboarding-style-31">
                Percentage of local/organic food: <strong className="onboarding-style-32">{answers.localFoodPct}%</strong>
              </label>
              <input
        ...
        {/* Step 3: Energy */}
        {step === 3 && (
          <div className="fade-in onboarding-style-33">
            <div className="onboarding-style-34">
              <div className="onboarding-style-35">
                <Flame size={24} />
              </div>
              <h3 className="onboarding-style-36">Home Utilities</h3>
            </div>

            <div>
              <label htmlFor="electricity-bill-slider" className="onboarding-style-37">
                Average monthly electricity bill (estimated): <strong className="onboarding-style-38">{answers.electricityBill} Units/Cost</strong>
              </label>
              <input
            ...
            <div>
              <label className="onboarding-style-39">Primary household energy source?</label>
              <div className="onboarding-style-40">
                {[
                  ...
                  >
                    <div className="onboarding-style-42">{opt.label}</div>
                    <div className="onboarding-style-43">{opt.desc}</div>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div>
              ...
              <div className="onboarding-style-45">
                {['small', 'medium', 'large'].map(sz => (
                  <button
                    key={sz}
                    type="button"
                    onClick={() => handleSelect('houseSize', sz)}
                    className="onboarding-style-46" style={{ background: answers.houseSize === sz ? 'rgba(6, 182, 212, 0.15)' : 'transparent', color: answers.houseSize === sz ? 'var(--text-primary)' : 'var(--text-muted)' }}
                  >
                    {sz}
                  </button>
                ))}
        ...
        {/* Step 4: Shopping */}
        {step === 4 && (
          <div className="fade-in onboarding-style-47">
            <div className="onboarding-style-48">
              <div className="onboarding-style-49">
                <ShoppingBag size={24} />
              </div>
              <h3 className="onboarding-style-50">Consumer Behavior</h3>
            </div>

            <div>
              <label className="onboarding-style-51">How would you describe your shopping habits?</label>
              <div className="onboarding-style-52">
                {[
                  ...
                  <div
                    ...
                    className="glass-card onboarding-style-53"
                  ...
                  >
                    <div className="onboarding-style-54">{opt.label}</div>
                    <div className="onboarding-style-55">{opt.desc}</div>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div>
              <label className="onboarding-style-56">How often do you recycle glass/plastics/paper?</label>
              <div className="onboarding-style-57">
                {[
                  ...
                  <div
                    ...
                    className="glass-card onboarding-style-58"
                  ...
                  >
                    <div className="onboarding-style-59">{opt.label}</div>
                    <div className="onboarding-style-60">{opt.desc}</div>
                  </div>
                ))}
              </div>
            </div>
        ...
        {/* Step 5: Summary */}
        {step === 5 && (
          <div className="fade-in onboarding-style-61">
            <div className="onboarding-style-62">
              <CheckCircle size={56} />
            </div>
            
            <div>
              <h3 className="onboarding-style-63">Onboarding Complete!</h3>
              <p className="onboarding-style-64">Your preliminary carbon footprint statistics have been generated.</p>
            </div>

            <div className="glass-card onboarding-style-65">
              <div className="onboarding-style-66">
                <div>
                  <div className="onboarding-style-67">
                    {calculateFootprint(answers).total}
                  </div>
                  <div className="onboarding-style-68">Tons CO₂/year</div>
                  <div className="onboarding-style-69">Current Footprint</div>
                </div>

                <div className="onboarding-style-70"></div>

                <div>
                  <div className="onboarding-style-71">
                    {calculateFootprint(answers).target}
                  </div>
                  <div className="onboarding-style-72">Tons CO₂/year</div>
                  <div className="onboarding-style-73">Your Target Goal</div>
                </div>
              </div>
            </div>

            <p className="onboarding-style-74">
        ...
        {/* Navigation Buttons */}
        <div className="onboarding-style-75">
          {step > 1 && step <= totalSteps + 1 && (
            <button
              onClick={prevStep}
              className="btn-ghost onboarding-style-76"
            >
              <ArrowLeft size={16} /> Back
            </button>
          )}

          <div className="onboarding-style-77" />

          {step <= totalSteps ? (
            <button
              onClick={nextStep}
              className="btn-primary onboarding-style-78"
            >
            ...
            <button
              ...
              className="btn-primary onboarding-style-79"
            >
